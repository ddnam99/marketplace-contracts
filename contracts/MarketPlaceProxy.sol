...
contract MarketPlaceProxy is AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setWhitelistNFTContract(
        ...
        emit Event.NFTContractAddressWhitelistChanged(nftContractAddress, isERC1155, allowance);
    }
    ...
    function setWhitelistPaymentToken(address paymentToken, bool allowance) public onlyAdmin {
        ...
        emit Event.PaymentTokenWhitelistChanged(paymentToken, allowance);
    }

    function setMarketFeePercent(uint256 newMarketFeePercent) public onlyAdmin {
        marketFeePercent = newMarketFeePercent;
        emit Event.MarketFeePercentChanged(newMarketFeePercent);
    }
    ...
    function cancelMarketItem(uint256 marketItemIndex) external nonReentrant whenNotPaused {
        ...
        emit Event.MarketItemCancel(marketItemIndex);
    }
